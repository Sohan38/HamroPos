...
export function LicenseBanner() {
  ...
  if (state.status === 'trial' && state.trial) {
    return (
      <div className="bg-gradient-to-r from-blue-600/95 to-indigo-600/95 text-white py-1.5 px-4 text-xs font-medium flex items-center justify-center gap-2 shadow-sm animate-in slide-in-from-top duration-300">
  ...
  if (!state.isUsable) {
    ...
    return (
      <div className="bg-gradient-to-r from-destructive/95 via-red-600/95 to-destructive/95 text-white py-2 px-4 text-xs font-semibold flex items-center justify-center gap-2 shadow-md animate-in slide-in-from-top duration-300">
  ...
  if (state.status === 'grace' && state.daysUntilExpiry !== null) {
    return (
      <div className="bg-gradient-to-r from-amber-500/95 to-orange-500/95 text-white py-1.5 px-4 text-xs font-medium flex items-center justify-center gap-2 shadow-sm animate-in slide-in-from-top duration-300">
