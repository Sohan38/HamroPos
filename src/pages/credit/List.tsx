  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-4xl mx-auto pb-24 md:pb-8">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Card className="border border-orange-500/10 bg-orange-500/[0.02] dark:bg-orange-500/[0.01] rounded-2xl shadow-sm overflow-hidden">
        ...
        <Card className="border border-emerald-500/10 bg-emerald-500/[0.02] dark:bg-emerald-500/[0.01] rounded-2xl shadow-sm overflow-hidden">
          <CardContent className="p-5 flex items-center justify-between">
            <div className="space-y-0.5">
